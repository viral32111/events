...
The mixins used in this repository are accurate as of release [`1.19-rc1`](https://maven.fabricmc.net/docs/yarn-1.19-rc1+build.1/). Feel free to submit [pull requests](https://github.com/viral32111/ExampleMod/pulls) to keep this project up-to-date if you have suggestions for new mixins to add, or encounter an existing one that is broken.
